        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <div className="relative h-3 bg-warm-stone/50 rounded-full overflow-hidden backdrop-blur-sm">
              <motion.div
                className="absolute inset-y-0 left-0 bg-gradient-hearth shadow-glow-sm"
                initial={{ width: 0 }}
                    ...
                    {onSkip && (
                      <div className="mt-4 text-center">
                        <button
                          type="button"
                          onClick={onSkip}
                          className="text-sm text-honey/70 hover:text-honey transition-colors inline-flex items-center gap-1"
                        >
                          <X className="w-3 h-3" />
          ...
          >
            <p className="text-sm text-honey/70">
              ...
              or{' '}
              <a href="/contact" className="text-ember-glow hover:text-hearth-fire underline">
                contact us
              </a>
            </p>
          </motion.div>
