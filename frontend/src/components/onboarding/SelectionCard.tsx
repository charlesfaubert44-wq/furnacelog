...
export const SelectionCard: React.FC<SelectionCardProps> = ({
  ...
  return (
    ...
    >
      ...
      {selected && (
        <div
          className="absolute top-3 right-3 w-6 h-6 rounded-full bg-wool-cream flex items-center justify-center animate-check-scale"
        >
...
export const SelectionListItem: React.FC<SelectionListItemProps> = ({
  ...
  return (
    ...
    >
      ...
      {selected && (
        <div
          className="flex-shrink-0 w-5 h-5 rounded-full bg-wool-cream flex items-center justify-center animate-check-scale"
        >
